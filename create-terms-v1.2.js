...
const newTermsContent = `StoreHub Merchant Onboarding Terms and Conditions
...
async function updateTermsFormatting() {
  ...
  const client = new Client({
    host: 'dpg-ctqhcj68ii6s73ekb0o0-a.oregon-postgres.render.com',
    port: 5432,
    database: 'storehub_merchant_onboarding',
    user: 'storehub_merchant_onboarding_user',
    password: 'storehub_secure_password_2024',
    ssl: {
  ...
  try {
    ...
    // First, deactivate existing active terms
    ...
    // Create new terms and conditions with updated formatting
    const insertQuery = `
...
// Run the function
updateTermsFormatting().catch(console.error); 